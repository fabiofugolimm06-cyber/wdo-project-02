"""
wdo_15min_donchian_puro.py - Donchian puro em 15min com custos reais
"""
...
def run_walk_forward_donchian(df):
    """Executa walk-forward com Donchian puro (sem filtro de volume)."""
    print("🚀 Executando walk-forward Donchian puro com custos...\n")
    all_trades = []
    ...
    for start in range(0, n - TRAIN_BARS - TEST_BARS, TEST_BARS):
        ...
        # Calcula Donchian no período de teste (usando dados anteriores)
...
def main():
    ...
    trades = run_walk_forward_donchian(df_15min)
